...
const vars = [
  ...
  { key: 'winner-size', group: '抽獎畫面', label: '中獎姓名字級', type: 'text', default: 'clamp(235px, calc(17 * var(--vw)), 555px)' },
  { key: 'name-gap', group: '抽獎畫面', label: '系所與姓名之間的距離', type: 'text', default: 'calc(3.5 * var(--vh))' },
  { key: 'dept-size', group: '抽獎畫面', label: '中獎系所字級', type: 'text', default: 'clamp(86px, calc(5.4 * var(--vw)), 162px)' },
  ...
  { key: 'reveal-top', group: '抽獎畫面', label: '揭曉區離畫面頂端距離（恭喜抽中／系所／姓名一起移動）', type: 'text', default: 'calc(14 * var(--vh))' },
